...
- (void)viewDidLoad
{
    ...
    
    {
        ...
        static CGFloat const TopInset = 28;
        static CGFloat const LeftInset = 20;
        _toggleIndexButton.frame = CGRectMake(0, 0, hashtagImage.size.width + LeftInset, hashtagImage.size.height + TopInset);
        _toggleIndexButton.imageEdgeInsets = UIEdgeInsetsMake(TopInset, LeftInset, 0, 0);
        _toggleIndexButton.contentMode = UIViewContentModeBottomRight;
